...
Each entry could either be an *axiom*, a *definition*, a *proposition* or a *remark*. Here, *proposition* is a generalized term for mathematical results, including theorems, lemmas, etc.
