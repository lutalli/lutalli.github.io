...
Pages in Codex are organized according to their **branches** (e.g. *Set Theory*, *Analysis*) and **topics** (e.g. *Functions*, *Series*). Each page discusses a specific **concept** within a topic (e.g. *Inverse Function* from the topic *Functions*).
