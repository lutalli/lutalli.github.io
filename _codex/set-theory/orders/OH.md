...
> {% codex OH#DEF:Order Homomorphism %}
>
...
- *Order homomorphism* is also known as *order-preserving function*.
...
- *Order antihomomorphism* is also known as *order-reversing function*.
