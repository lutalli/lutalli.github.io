...
In $\ZF$, everything is a set. Nevertheless, we introduce *classes* to make our life easier. A class is an informal, set-like notion that describes a collection of sets satisfying a certain property. Through classes, we can treat formulas like sets.
