...
>
> The arity of a relation is not an intrinsic attribute, as the arity of a tuple is not an intrinsic attribute ([REM-TUP-AR](/codex/TUP#REM-TUP-AR)). For example, a ternary relation on $X$, $Y$ and $Z$ could also be seen as a binary relation on $X\times Y$ and $Z$.
