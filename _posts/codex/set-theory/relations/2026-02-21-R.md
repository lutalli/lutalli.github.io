...
> **REM-R-AR.**{: .codex-h }
>
> Since the arity of a tuple is not an intrinsic property ([REM-TUP-AR](/codex/TUP#REM-TUP-AR)), nor is the arity of a relation. For example, a ternary relation on $X$, $Y$ and $Z$ could also be seen as a binary relation on $X\times Y$ and $Z$.
