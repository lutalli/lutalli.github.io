...
> $$ A\cup B = \bigcup\{A,B\}. $$
>
> For any three sets $A$, $B$ and $C$, we define the **union of $A$, $B$ and $C$** as
>
...
> <span class="math-h">DEF-ZF-IND. Inductive Set.</span>
>
> A set $X$ is **inductive** if $\varnothing\in X$ and
>
...
> <span class="math-h">REM-ZF-R.</span>
>
