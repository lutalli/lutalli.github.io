...
- In logical formulas, $\rightarrow$ is used for material implication instead of $\Rightarrow$.
  ...
  - $\Rightarrow$ is reserved for implication in the meta langauge, as a shorthand for words like *so that*, *it follows that*, *therefore*, etc. in the argumentation. Example: If $x\in\R$, then
