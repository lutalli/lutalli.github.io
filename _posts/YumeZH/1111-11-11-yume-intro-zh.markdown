...
| <code>word</code> | 标签 | 交代当下的地点、环境、时间、气氛、心理、认知等相对静态、全局、漂浮、填充式的信息，或是对某个描述的补充<br />穿插在正文之间 |
...
| <code>~&nbsp;word</code> | <code>~</code>标签 | 交代某样事物在梦中产生的联想、对某样事物身份的认知<br />当经历事物 X、心里感觉这仿佛是 Y 但又没有理所当然地把它当成是 Y 时，会使用该符号<br />如果认知百分之百地告诉自己看到了一只鸟飞过，就会直接写「一只鸟飞过」；若只是对于某个事物有「鸟」的感受，但认知仍然模糊（或者说：「那是鸟」和「不知道那是什么」的认知**同时存在**），就可能会写「一个东西 <code>~&nbsp;鸟</code> 飞过」|
| [&nbsp;...&nbsp;]<br />[word] | 直角括号 | 描写心理活动<br />直角括号括起来的完整句子是对梦中我心里的想法、认知的直接描述，可以认为是「我想：...」的缩写<br />直角括号括起来的词语则是表示该词语包含了梦中经历的感受、心理的细微变化，例如 [竟然] 表示梦中对某件事感到诧异<br />用这种方式可以让行文与心理描写融为一体 |
...
| ❐ ... | 方块符号 | （以现实的视角）对梦的评论、注释等<br />放在一个梦的结尾之后 |
